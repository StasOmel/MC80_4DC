...
#include "../YAFFS2/YAFFS_direct/yaffsfs.h"
...
int Yaffs_nor_write_chunk_tags(struct yaffs_dev *dev, int nand_chunk,
                               const u8 *data, const yaffs_ext_tags *tags);

// Read chunk with tags from NOR Flash
int Yaffs_nor_read_chunk_tags(struct yaffs_dev *dev, int nand_chunk,
